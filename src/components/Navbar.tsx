...
const Navbar = async () => {
  ...
  return (
    <div className="fixed inset-x-0 top-0 bg-blue-500 dark:bg-gray-800 z-[10] h-fit border-b border-gray-300 dark:border-gray-700 py-2 shadow-lg dark:shadow-purple-300">
